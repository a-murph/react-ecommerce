	...
	render() {
		return (
			<nav className="menu-bar">
				...
				<div className="nav-home-logo"><Link to="/"><img alt="West Indigo logo" className="logo-nav" src="/img/logo3.svg"/></Link></div>
				...
				<div className="nav-cart-button pointer"><img alt="Cart" className="img" src="/img/shopping-cart-solid.svg"/><span className="nav-title-font">Cart</span></div>
			</nav>
		);
	};
};
