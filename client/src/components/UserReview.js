...
const UserReview = props => (
	<div className="review">
		<div className="review-header">
			<div className="review-item"><span className="review-title-font">{props.review.title}</span> <span className="review-body-font"><img src={`/img/stars/${props.review.rating}-star.svg`} alt={`${props.review.rating} stars`}></img> </span> <i className="fas fa-check-circle"></i></div>
