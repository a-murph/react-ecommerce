...
const UserReview = props => (
	<div className="review">
		<div className="review-header">
			<div className="review-item"><span className="review-title-font">Review Title</span> <span className="review-body-font">{props.review.rating} out of 5 Stars </span> <i class="fas fa-check-circle"></i></div>
		...
		<div className="review-footer">
			...
			<div className="review-item review-buttons"> 
				<div><a href="##" className="product-body-font"><i class="far fa-thumbs-up"></i><span> Helpful</span></a></div>
				<div><a href="##" className="product-body-font"><i class="far fa-comment"></i><span> Comment</span></a></div>
				<div><a href="##" className="product-body-font"><i class="far fa-flag"></i><span> Report Abuse</span></a></div>
			</div>
		</div>
	</div>
);
